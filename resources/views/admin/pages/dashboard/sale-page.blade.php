        ...
        function ShowInvoiceItem() {
            ...
            InvoiceItemList.forEach(function(item, index) {
                let row = `<tr class="text-xs">
                        ...
                        <td><a data-index="${index}" class="btn-danger remove text-xxs px-2 py-1   btn-sm m-0">Remove</a></td>
                     </tr>`
        ...
        async function CustomerList() {
            ...
            res.data.forEach(function(item, index) {
                let row = `<tr class="text-xs">
                        ...
                        <td><a data-name="${item['name']}" data-email="${item['email']}" data-id="${item['id']}" class="btn-success addCustomer  text-xxs px-2 py-1  btn-sm m-0">Add</a></td>
                     </tr>`
